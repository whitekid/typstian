...
export const COMPILER_CLIENT_ERROR = {
  ...
  wrongTooltipRevision: "Compiler returned the wrong tooltip revision.",
  wrongTooltipResponse: "Compiler returned the wrong tooltip response.",
  tooltipTooLarge: "Compiler returned tooltip content above its size limit.",
  ...
  tooltipByteOffsetInvalid: "Tooltip byte offset is invalid.",
  tooltipSideInvalid: "Tooltip side is invalid.",
  tooltipSourceTooLarge: "Tooltip source text is too large.",
  tooltipRequestInvalid: "Tooltip request is invalid.",
